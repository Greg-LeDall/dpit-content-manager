...
// .wrangler/tmp/bundle-yVFhL5/checked-fetch.js
...
postsHandler.post("/", async (c) => {
  try {
    ...
    const engagementRate = post.views > 0 ? ((post.likes + post.comments + post.shares) / post.views * 100).toFixed(2) : 0;
    const sql = `
      INSERT INTO posts 
...
// src/handlers/calendar.js
var calendarHandler = new Hono2();
...
var analyticsHandler = new Hono2();
...
// .wrangler/tmp/bundle-yVFhL5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yVFhL5/middleware-loader.entry.ts
